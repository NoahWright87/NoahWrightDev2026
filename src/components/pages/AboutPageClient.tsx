      ...
      <Container padding="lg">
        <Container direction="vertical" itemSpacing="md">
          ...
          <Container direction="vertical" itemSpacing="xs">
            ...
            <Text>
              Family is everything to me. My wife and I care for our disabled adult child, which has taught me both patience and the deep importance of finding ways to make life easier for people who struggle with everyday tasks. That's part of why I'm passionate about empowering tools—I see the real-world impact they have. When I'm not building software, I'm still a gamer and fun-loving goofball. I make silly side projects, toys, and games, mostly on my fake Doors 97 operating system. That playful spirit has never left me, and I don't think it ever should.
            </Text>
          </Container>
